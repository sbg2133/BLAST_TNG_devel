...
class roachInterface(object):
    ...
    def __init__(self):
        self.bitstream = "./fpgs/bin4096_2016_Jul_25_1755.fpg"
	...
	neg_freqs, neg_delta = np.linspace(-255.021234e6+5.0e4, -5.2342e6+5.0e4, 500, retstep = True)
	#neg_freqs, neg_delta = np.linspace(-200., -20.2342e6 + 5.0e4, 200, retstep = True)
	pos_freqs, pos_delta = np.linspace(5.2342e6,255.021234e6, 500, retstep = True)
	...
	self.LUTbuffer_len = 2**21
        ...
        self.fft_len = 4096
        self.accum_len = (2**19) # For 488 Hz 
